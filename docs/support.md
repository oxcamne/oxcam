...
The online database is an open source [project](https://github.com/oxcamne/oxcam). Please start by reading the project README you will see there (you probably came here from there!).
 ...
 Oxcam is a [Python](https://www.python.org) App running under the open source web framework [Py4web](https://github.com/web2py/py4web). Please see the Py4web documentation for information on it's installation. See the [contents](contents.md) page for a description of the app structure.
