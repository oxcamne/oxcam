...
Ticking the **Members Only** checkbox restricts registration to members in good-standing at the time the event will take place. Full members with auto-renewing subscriptions will be assumed to be in good standing even if the event takes place after their currently paid date. Non-member alums and members whose renewal date precedes the event will need to join or renew at the time of registration. In some cases, such as Freshers' events and new Member recruitment events there may be ticket types that override the members-only restriction.
...
Leaving Members Only unchecked allows any alumnus to register.
